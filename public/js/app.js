...
var findParksNearMeButton = document.querySelector("#near-me"); // When user click Find Parks Near Me button get user location

findParksNearMeButton.onclick = function () {
  FindParksNearMe();
